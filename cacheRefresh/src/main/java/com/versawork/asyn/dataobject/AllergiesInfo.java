...
public class AllergiesInfo implements Serializable {
	...
	public void setSourceName(String sourceName) {
		...
		if (sourceName != null) {
			...
			this.sourceName = VersaworkConstants.NOT_APPLICABLE.getMessage();
		}
	...
	public void setAllergenCode(String allergenCode) {
		...
		if (allergenCode != null) {
			...
			this.allergenCode = VersaworkConstants.NOT_APPLICABLE.getMessage();
		}
	}
	...
	public void setReactionCode(String reactionCode) {
		...
		if (reactionCode != null) {
			...
			this.reactionCode = VersaworkConstants.NOT_APPLICABLE.getMessage();
		}
	}
	...
	public void setReaction(String reaction) {
		...
		if (reaction != null) {
			...
			this.reaction = VersaworkConstants.NOT_APPLICABLE.getMessage();
		}
	}
