 ...
 */
//@Repository
public class GetCacheRefreshDao {
...
//  @PersistenceContext(unitName = "versawork_DS", type = PersistenceContextType.TRANSACTION)
  ...
  public List<PatientLab> getPatientLabResult(long transactionId, int clientDatabaseId) {
...
//      }
   ...
   * @return
   */
  public List<PatientAllergy> getPatientAllergies(long transactionId, int clientDatabaseId) {
...
//      }
   ...
   * @return
   */
  public List<PatientImaging> getPatientImages(long transactionId, int clientDatabaseId) {
...
//      synchronized (GetCacheRefreshDaoBadIdea.class) {
  ...
  public List<PatientPrescription> getPatientPrescriptions(long transactionId, int clientDatabaseId) {
...
//      synchronized (GetCacheRefreshDaoBadIdea.class) {
  ...
  public List<PatientProblem> getPatientProblems(long transactionId, int clientDatabaseId) {
...
*/    } catch (Exception e) {
  ...
  public List<PatientVitalSign> getPatientVitalSign(long transactionId, int clientDatabaseId) {
...
//      }
   ...
   * @return
   */
  public List<PatientCareTeam> getPatientCareTeam(long transactionId, int clientDatabaseId) {
...
*/    } catch (Exception e) {
   ...
   * @return
   */
  public List<PatientProcedure> getPatientProcedures(long transactionId, int clientDatabaseId) {
...
//      }
   ...
   * @return
   */
  public List<PatientCarePlan> getPatientCarePlan(long transactionId, int clientDatabaseId) {
...
*/    } catch (Exception e) {
   ...
   * @return
   */
  public List<PatientDiagnosis> getPatientDiagnosis(long transactionId, int clientDatabaseId) {
...
//      }
   ...
   * @return
   */
  public List<PatientImmunization> getPatientImmunization(long transactionId, int clientDatabaseId) {
...
//      }
   ...
   * @return
   */
  public List<FacilityNotice> getHospitalNotice(int clientDatabaseId) {
...
//      }
   ...
   * @return
   */
  public List<FacilityProvider> getDoctorsList(int clientDatabaseId) {
...
*/    
   ...
   * @return
   */
  public List<FacilityService> getServicesList(int clientDatabaseId) {
...
//      }
   ...
   * @return
   */
  public List<PatientVisit> getPatientVisit(long transactionId, int clientDatabaseId) {
