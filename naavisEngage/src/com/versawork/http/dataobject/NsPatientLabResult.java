...
public class NsPatientLabResult implements Serializable {
	...
	private Float maxRangeMin;
	private Float maxRangeMax;
	...
	/**
	 * @param maxRangeMin
	 *            the maxRangeMin to set
	 */
	public void setMaxRangeMin(Float maxRangeMin) {
		this.maxRangeMin = maxRangeMin;
	}

	/**
	 * @return the maxRangeMax
	 */
	...
	/**
	 * @param maxRangeMax
	 *            the maxRangeMax to set
	 */
	public void setMaxRangeMax(Float maxRangeMax) {
