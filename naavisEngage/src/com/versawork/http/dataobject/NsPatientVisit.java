...
public class NsPatientVisit implements Serializable {
	...
	public void setVisitDate(String visitDate) {
		if (visitDate != null) {
			...
			this.visitDate = VersaWorkConstant.NOT_APPLICABLE;
		}
	}
	...
	public void setSex(String sex) {
		if (sex != null) {
			...
			this.sex = VersaWorkConstant.NOT_APPLICABLE;
		}
	}
	...
	public void setRaceCode(String raceCode) {
		if (raceCode != null) {
			...
			this.raceCode = VersaWorkConstant.NOT_APPLICABLE;
		}
	}
	...
	public void setEthnicity(String ethnicity) {
		if (ethnicity != null) {
			...
			this.ethnicity = VersaWorkConstant.NOT_APPLICABLE;
		}
	}
	...
	public void setEthnicityCode(String ethnicityCode) {
		if (ethnicityCode != null) {
			...
			this.ethnicityCode = VersaWorkConstant.NOT_APPLICABLE;
		}
	}
	...
	public void setPreferredLanguage(String preferredLanguage) {
		if (preferredLanguage != null) {
			...
			this.preferredLanguage = VersaWorkConstant.NOT_APPLICABLE;
		}
	}
	...
	public void setSmokingStatus(String smokingStatus) {
		if (smokingStatus != null) {
			...
			this.smokingStatus = VersaWorkConstant.NOT_APPLICABLE;
		}
	}
	...
	public void setSmokingStatusCode(String smokingStatusCode) {
		if (smokingStatusCode != null) {
			...
			this.smokingStatusCode = VersaWorkConstant.NOT_APPLICABLE;
		}
	}
