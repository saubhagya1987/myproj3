...
public class LabResultInfo implements Serializable {
	...
	public void setOrgName(String orgName) {
		if (orgName != null) {
			...
			this.orgName = VersaWorkConstant.NOT_APPLICABLE;
		}
	}
	...
	public void setOrgCode(String orgCode) {
		if (orgCode != null) {
			...
			this.orgCode = VersaWorkConstant.NOT_APPLICABLE;
		}
	}
	...
	public void setInterpretationCode(String interpretationCode) {
		if (interpretationCode != null) {
			...
			this.interpretationCode = VersaWorkConstant.NOT_APPLICABLE;
		}
	}
	...
	public void setLabTestCode(String labTestCode) {
		if (labTestCode != null) {
			...
			this.labTestCode = VersaWorkConstant.NOT_APPLICABLE;
		}
	}
