 ...
 * 
 */
public class InpatientImmunizationListComparator implements Comparator<PatientInpatientImmunalizationInfo> {

	@Override
	public int compare(PatientInpatientImmunalizationInfo o1, PatientInpatientImmunalizationInfo o2) {
