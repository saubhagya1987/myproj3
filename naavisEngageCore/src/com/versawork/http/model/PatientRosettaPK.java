 ...
 */
@Embeddable
public class PatientRosettaPK implements Serializable {
	/**
	 * 
	 */
	...
	public PatientRosettaPK() {
	}

	public PatientRosettaPK(int clientId, int clientDatabaseId, String medicalRecordNumber) {
	...
	public boolean equals(Object object) {
		...
		// not set
		if (!(object instanceof PatientRosettaPK)) {
			return false;
		}
		PatientRosettaPK other = (PatientRosettaPK) object;
	...
	public String toString() {
		return "com.versawork.http.model.PatientRosettaPK[ clientId=" + clientId + ", clientDatabaseId="
